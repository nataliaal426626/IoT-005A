...
### Profesor
* **Professor in charge:** Muhammad Zubair Islam
* **University:** Sejong University

---

### Members and Task Division

Aquí puedes encontrar los perfiles y páginas personales de los miembros del equipo:

* **[Natalia (Leader)](https://nataliaal426626.github.io/IoT-005A/)**
    * **Rol:** System Design, Data Analysis and Coordination
    * **Description:** Design the complete ESP32-based circuit in Wokwi, verify simulation flows, simulate varying conditions & analyze serial monitor outputs. Overall co-ordination of the project.​

* **[Khan](https://khan-webpage.com)**
    * **Rol:** Algorithm Development & Integration, Optimization​
    * **Description:** Develop the quantum-inspired probabilistic forecast algorithm, integrate it into ESP32 code, process sensor inputs, and fine-tune parameters for stable simulation performance.​

* **[Alve](https://alve-webpage.com)**
